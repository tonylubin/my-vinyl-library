...
const SearchBar = () => {
  ...
  return (
    <div className=' flex gap-4 items-center relative pr-12'>
        ...
        <input className="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-full py-1 pl-9 pr-3 shadow-md focus:outline-none focus:border-blue-700 focus:ring-blue-700 focus:ring sm:text-sm" placeholder="Search artist/title..." type="text" name="search" onChange={handleSearchInput}/>
    </div>
  )
}
